...
if ( ${timeset} =- "JST" ) then
	convert -loop 0 -delay 150 ${dir}/tenkizu/png/*.pdf ${dir}/tenkizu/gif/${s_yy}${m0}${d0}.gif
else if ( ${timeset} == "UTC" ) then
	convert -loop 0 -delay 150 ${dir}/tenkizu/png/*.jpg ${dir}/tenkizu/gif/${s_yy}${m0}${d0}.gif
endif
